# Function to prepare the system prompt for the interactive fiction generator
...
# Function to prepare the prompt for defining the story based on theme and setting
def prepare_define_story_prompt(theme, setting):
    DEFINE_STORY_PROMPT = "Define a start point and an end goal or condition for a random interactive fiction story."
    if theme:
...
# Function to prepare the prompt for generating the story based on the story definition and whether choices are included
